...
from model import DAPSynergy_v2_multimodal
...
modeling = DAPSynergy_v2_multimodal
...
for i in range(5):
    ...
    model_file_name = 'data/result/DAPSynergy_v2_multimodal_' + str(i) + '--model_' + datafile + '.model'
    result_file_name = 'data/result/DAPSynergy_v2_multimodal_' + str(i) + '--result_' + datafile + '.csv'
    file_AUCs = 'data/result/DAPSynergy_v2_multimodal_' + str(seed) + str(i) + '--AUCs--' + datafile + '.txt'
    AUCs = ('Epoch\tAUC_dev\tPR_AUC\tACC\tBACC\tPREC\tTPR\tKAPPA\tRECALL')
    model_path = 'data/result/weight/' + str(seed) + 'model_v2_multimodal_' + str(i) + '.pt'
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        # # save data
        AUCs = [epoch, AUC, PR_AUC, ACC, BACC, PREC, TPR, KAPPA, recall_score_val]
